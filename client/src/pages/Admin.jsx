...
const Admin = ({ server }) => {
  ...
  return (
    <div className="bg-white w-full h-full sm:min-h-screen flex flex-col sm:flex-row p-5 sm:p-0">
      <Icon
        className="absolute size-12 cursor-pointer hover:p-1 top-2 right-2 rounded-full bg-white p-2 transition-all duration-300"
        icon="bxs:home"
        onClick={() => navig("/")}
      />
      ...
      <div className="w-full sm:w-1/2 flex h-full py-3 sm:py-0 sm:min-h-screen flex-col items-center justify-center">
        ...
        <h1 className="text-2xl font-extrabold font-mono text-blue-600">
          ...
          <div className="m-1 p-1">
            <label className="text-lg">
              ...
              <div className="flex flex-col justify-evenly space-y-2">
                <input
                  className="border-2 border-gray-300 rounded-md size-8 p-2 w-full"
                  type="text"
                  placeholder="img Url..."
